;(function($){
	...
	$.fn.Carouseltab2 = function(options){
		...
		return this.each(function(idx,ele){
			...
			$.each(opt.text1,function(idx,text1){
				$('<li/>').html(`<a href="" title="${text1}">${text1}</a>`).addClass('text1').appendTo($ul01);
			});
			$.each(opt.text2,function(idx,text2){
				$('<li/>').html(`<a href=""  title="${text2}">${text2}</a>`).addClass('text2').appendTo($ul02);
			});
			$.each(opt.text3,function(idx,text3){
				$('<li/>').html(`<a href="" title="${text3}" >${text3}</a>`).addClass('text3').appendTo($ul03);
			});
